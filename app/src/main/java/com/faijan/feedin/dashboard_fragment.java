                                            ...
                                            db.collection( "Donations" )
                                                    ...
                                                    .addOnSuccessListener( new OnSuccessListener<DocumentSnapshot>() {
                                                        ...
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            ...
                                                            LocalDateTime currentTime = null, newDateTime = null, oldDateTime = null;
                                                            ...
                                                            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                                                                ...
                                                                newDateTime = LocalDateTime.parse(currentTimeStr, formatter);
                                                            ...
                                                            if (!foodStatus.equals( "Requested" ) && !foodStatus.equals( "Accepted" ) && foodStatus.equals( "Visible" )) {
                                                                ...
                                                                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                                                                    ...
                                                                    oldDateTime  = LocalDateTime.parse(documentSnapshot.getString( "bestBefore" ).toString(), formatter);

                                                                    hoursGap = ChronoUnit.HOURS.between(newDateTime,oldDateTime);

                                                                }
                                                                donateFoodClass.setBestBefore( "Best before "+hoursGap+" hours");
